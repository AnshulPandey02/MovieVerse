...
>
  <textarea
    ...
    className="w-full h-32 p-3 rounded-lg bg-gray-800/80 text-gray-100 text-sm placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-[#00A8E1]"
  />
  <div className="flex gap-4 mt-4">
    <button
      onClick={handleSaveNote}
      className="px-5 py-2 bg-gradient-to-r from-[#005C7E] to-[#00A8E1] hover:from-[#00739D] hover:to-[#00C2FF] rounded-lg text-white text-sm font-semibold shadow-md hover:shadow-[#00A8E1]/30 transition-all duration-200"
    >
      Save
    </button>
    <button
