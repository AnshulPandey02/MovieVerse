    ...
    <div className="bg-[#121212] p-4 rounded-xl shadow-lg border border-gray-800 mb-6">
      ...
      <form onSubmit={handleSearchSubmit} className="flex flex-col md:flex-row items-center gap-3">
        <div className="relative flex-1 w-full">
          ...
          {query && (
            <FaTimes
              className="absolute right-3 top-3 text-gray-400 hover:text-[#00A8E1] cursor-pointer transition"
        ...
        <div className="flex w-full sm:w-max gap-2 justify-between sm:justify-start">
          <button
            ...
            className="cursor-pointer bg-gradient-to-r from-[#005C7E] to-[#00A8E1]
                        hover:from-[#00739D] hover:to-[#00C2FF]
                        shadow-md hover:shadow-[0_0_10px_#00A8E1]
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between w-full">
              ...
              <button
                ...
                className={`relative w-14 h-8 rounded-full p-1 transition-transform focus:outline-none focus:ring-2 focus:ring-[#00A8E1]
                           ${upcoming ? "bg-gradient-to-r from-[#005C7E] to-[#00A8E1]" : "bg-[#2a2a2a]"}`}
              >
                <span
            ...
            <button
              onClick={handleApply}
              className="cursor-pointer w-full bg-gradient-to-r from-[#005C7E] to-[#00A8E1]
                         hover:from-[#00739D] hover:to-[#00C2FF]
                         hover:shadow-[0_0_12px_#00A8E1]
