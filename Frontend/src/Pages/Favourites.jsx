    ...
    return (
      <div className="bg-[#0f0f0f] min-h-screen flex flex-col items-center justify-center text-center text-white p-6">
        <div className="flex flex-col items-center space-y-4">
          ...
          <h1 className="text-3xl font-bold text-[#00A8E1]">Your Favourites List is Empty</h1>
  ...
  return (
    <div className="bg-[#0f0f0f] min-h-screen text-white p-6">
      ...
      <div className="flex items-center gap-2 mb-8">
        <RiMovie2Fill className="text-3xl text-[#00A8E1]" />
        <h1 className="text-2xl sm:text-3xl font-bold text-[#00A8E1]">Your Favourites</h1>
      </div>
