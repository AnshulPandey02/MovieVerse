      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 py-10 flex flex-col gap-12">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
          ...
          <div className="flex-1 space-y-5 text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl font-bold text-[#00A8E1]">
              {movie.title}
            </h1>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-x-8 gap-y-3 text-gray-300 text-sm sm:text-base">
              ...
              <p className="flex items-center gap-2">
                <MdCalendarMonth className="text-[#00A8E1]" />{" "}
                {movie.release_date}
              </p>
              <p className="flex items-center gap-2">
            ...
            <div className={infoButtonsClass}>
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2 rounded-xl bg-gradient-to-r from-[#005C7E] to-[#00A8E1] hover:from-[#00739D] hover:to-[#00C2FF] text-white font-semibold shadow-md hover:scale-105 transition"
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition cursor-pointer ${
                  isInWatchlist
                    ? "bg-gradient-to-r from-[#005C7E]/60 to-[#00A8E1] text-white"
                    : "bg-[#1b1b1b] text-[#00A8E1] border border-[#00A8E1]/40 hover:bg-[#00A8E1]/20"
                } ${
        ...
        {backdropUrl && (
          ...
          >
            <h3 className="text-2xl font-semibold mb-3 text-[#00A8E1]">
              Banner 
            </h3>
            <div
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                ...
                <div className="hidden md:flex absolute bottom -5 right-5 items-center gap-3 z-10">
                  ...
                  <button
                    onClick={() => window.open(trailer, "_blank")}
                    className="flex items-center gap-2 px-4 py-2 rounded-md bg-gradient-to-r from-[#005C7E] to-[#00A8E1] hover:from-[#00739D] hover:to-[#00C2FF] text-white font-semibold shadow-md hover:scale-105 transition"
                  >
