  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-[#0a0a0a] text-gray-200 px-5 my-10">
      ...
      >
        ...
        <div className="md:w-1/2 w-full bg-gradient-to-br from-[#005C7E] to-[#0a0a0a] flex flex-col justify-center items-center p-8 text-center">
          ...
          <div className="flex justify-center gap-6 mt-3">
            ...
            >
              <FaBookmark
                className="text-[#00A8E1] mx-auto mb-1 group-hover:text-[#00C2FF] transition"
                size={22}
              />
              <span className="text-sm text-gray-300 group-hover:text-white transition">
            ...
            {editingLang && (
              <div className="flex gap-2 justify-center mt-3">
                <button
                  ...
                  className="bg-[#00A8E1] px-4 py-1 rounded-md hover:bg-[#0084B4] transition font-medium"
                >
                  Save
                </button>
                <button
          ...
          <div className="text-center mb-6">
            ...
            {user.isGoogleUser ? (
              ...
              <button
                ...
                className="bg-[#00A8E1] hover:bg-[#0084B4] px-5 py-1 rounded-md font-medium transition"
              >
                Change Password
              </button>
            ) : (
              <div className="flex flex-col gap-3 mt-3">
                ...
                <div className="flex gap-2 mt-3">
                  <button
                    ...
                    className="bg-[#00A8E1] w-1/2 py-2 rounded-md font-medium hover:bg-[#0084B4] transition"
                  >
                    Save
                  </button>
                  <button
