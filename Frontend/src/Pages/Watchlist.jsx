    ...
    return (
      <div className="bg-[#0f0f0f] min-h-screen flex flex-col items-center justify-center text-center text-white p-6">
        <div className="flex flex-col items-center space-y-4">
          <BsBookmarkHeartFill className="text-6xl text-gray-500 drop-shadow-[0_0_10px_#00A8E1]" />
          <h1 className="text-3xl font-bold text-[#00A8E1]">Your Watchlist is Empty</h1>
          ...
          <button
            onClick={() => navigate("/")}
            className="mt-6 px-6 py-2 rounded-lg bg-[#00A8E1] hover:bg-[#0084B4] text-white font-semibold shadow-lg transition-all duration-300"
          >
            Explore Movies
          </button>
        </div>
  ...
  return (
    <div className="bg-[#0f0f0f] min-h-screen text-white p-6">
      ...
      <div className="flex items-center gap-2 mb-8">
        <MdMovieFilter className="text-3xl text-[#00A8E1]" />
        <h1 className="text-2xl sm:text-3xl font-bold text-[#00A8E1]">Your Watchlist</h1>
      </div>
